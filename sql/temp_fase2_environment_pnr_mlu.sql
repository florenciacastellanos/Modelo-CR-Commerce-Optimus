-- FASE 2: Drill-down por ENVIRONMENT - PNR MLU - Nov vs Dic 2025
-- Apertura: ENVIRONMENT
...
SELECT 
  ENVIRONMENT,
  SUM(CASE WHEN MES = '2025-11-01' THEN 1 ELSE 0 END) AS INC_P1,
  SUM(CASE WHEN MES = '2025-12-01' THEN 1 ELSE 0 END) AS INC_P2,
  SUM(CASE WHEN MES = '2025-12-01' THEN 1 ELSE 0 END) - SUM(CASE WHEN MES = '2025-11-01' THEN 1 ELSE 0 END) AS VAR_CASOS,
  COUNT(DISTINCT CAS_CASE_ID) AS TOTAL
FROM classified
WHERE AGRUP_COMMERCE = 'PNR'
GROUP BY 1
ORDER BY ABS(SUM(CASE WHEN MES = '2025-12-01' THEN 1 ELSE 0 END) - SUM(CASE WHEN MES = '2025-11-01' THEN 1 ELSE 0 END)) DESC
