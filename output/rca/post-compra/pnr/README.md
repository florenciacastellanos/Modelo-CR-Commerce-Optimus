# 📊 Reportes PNR - Commerce Post-Compra

**Commerce Group:** PNR (Producto No Recibido)  
...
|---------|---------|------|---------|
| `golden-pnr-mlb-nov-dic-2025.html` | v4.0 | MLB | Nov-Dic 2025 |
...
- **Ejemplos:** `ejemplos/ejecutar_reporte_pnr_mlb.ps1`
