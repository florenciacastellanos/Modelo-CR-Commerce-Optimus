# Ejemplo de Ejecución - Reporte PDD MLA Nov-Dic 2025
# ======================================================
# Este script ejecuta el Template Universal v6.3.4 para PDD MLA
...
Write-Host "Caso: PDD MLA Nov-Dic 2025" -ForegroundColor Green
...
# Ejecutar el script con parámetros (usando py.exe - Python Launcher)
